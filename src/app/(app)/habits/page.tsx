  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link href="/habits/new" className="btn-primary text-sm">+ New Habit</Link>
      </div>
        ...
        {habits.map(h => (
          <div key={h.id} className="card card-hover">
            <div className="flex items-start justify-between mb-3">
              ...
              <span className="text-xs bg-white/5 border border-white/10 text-gray-400 px-2 py-0.5 rounded-full">{h.frequency}</span>
            </div>
