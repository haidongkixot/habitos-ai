  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <Link href="/habits/new" className="bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-lg text-sm transition-colors">
          + New Habit
        </Link>
      </div>
      ...
      <div className="space-y-3">
        ...
        {habits.length > 0 ? habits.map(h => (
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-8 text-center">
            ...
            <p className="text-gray-400 text-sm mb-4">Start by creating your first habit</p>
            <Link href="/habits/new" className="bg-emerald-500 hover:bg-emerald-600 text-white px-6 py-2 rounded-lg text-sm transition-colors">
              Create First Habit
            </Link>
          </div>
        )}
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
        <div className="flex items-center justify-between mb-3">
          ...
          <button onClick={getCoaching} className="text-emerald-400 text-sm hover:underline">Get Advice</button>
        </div>
        {coaching ? (
          <p className="text-gray-300 text-sm">{coaching}</p>
        ) : (
          <p className="text-gray-500 text-sm">Click &quot;Get Advice&quot; for personalized habit coaching.</p>
        )}
      </div>
    </div>
  )
