...
async function main() {
  ...
  const templatePacks = [
    ...
    // Pack 4: Cognitive Performance
    { name: 'Daily Reading', description: 'Read for 20 minutes to build knowledge and focus. Choose non-fiction, technical material, or literature that stretches your thinking and expands your perspective.', category: 'learning', frequency: 'daily', icon: '📚', color: '#6366F1', packName: 'Cognitive Performance', difficulty: 'beginner', benefits: ['Expanded knowledge', 'Improved focus', 'Better vocabulary'], sortOrder: 0 },
    { name: 'Brain Training', description: '15 minutes of cognitive exercises on MemoryForge or similar platforms. Puzzles, memory games, and pattern recognition tasks to sharpen mental agility.', category: 'learning', frequency: 'daily', icon: '🧠', color: '#8B5CF6', packName: 'Cognitive Performance', difficulty: 'beginner', benefits: ['Sharper memory', 'Faster processing', 'Better problem-solving'], sortOrder: 1 },
    { name: 'Learn Something New', description: 'Dedicate 30 minutes to learning a new skill. Whether it is a language, instrument, coding, or craft — deliberate practice builds neural pathways and keeps your brain adaptable.', category: 'learning', frequency: 'daily', icon: '🎯', color: '#3B82F6', packName: 'Cognitive Performance', difficulty: 'intermediate', benefits: ['Skill acquisition', 'Neural plasticity', 'Personal growth'], sortOrder: 2 },

    // Pack 5: Social & Emotional
    { name: 'Gratitude Message', description: 'Send one heartfelt thank-you message to someone in your life. Expressing genuine gratitude strengthens relationships and boosts your own well-being.', category: 'wellness', frequency: 'daily', icon: '💌', color: '#EC4899', packName: 'Social & Emotional', difficulty: 'beginner', benefits: ['Stronger relationships', 'Increased happiness', 'Social connection'], sortOrder: 0 },
    { name: 'Active Listening', description: 'Have one fully present conversation without distractions. Put away your phone, make eye contact, and focus entirely on understanding the other person.', category: 'wellness', frequency: 'daily', icon: '👂', color: '#10B981', packName: 'Social & Emotional', difficulty: 'intermediate', benefits: ['Deeper connections', 'Better empathy', 'Improved communication'], sortOrder: 1 },
    { name: 'Compliment Someone', description: 'Give one genuine, specific compliment to someone today. Specific praise is more meaningful than generic — notice something real and say it out loud.', category: 'wellness', frequency: 'daily', icon: '🌟', color: '#F59E0B', packName: 'Social & Emotional', difficulty: 'beginner', benefits: ['Positive relationships', 'Social awareness', 'Mood boost'], sortOrder: 2 },
    { name: 'Weekly Check-in Call', description: 'Call a friend or family member you have not spoken to recently. Maintaining relationships requires intentional effort — one call per week keeps your social bonds strong.', category: 'wellness', frequency: 'weekly', icon: '📞', color: '#06B6D4', packName: 'Social & Emotional', difficulty: 'beginner', benefits: ['Maintained relationships', 'Reduced isolation', 'Emotional support'], sortOrder: 3 },

    // Pack 6: Environmental Design
    { name: 'Evening Prep Ritual', description: 'Prepare tomorrow\'s habit cues before bed. Lay out workout clothes, set up your journal, prep breakfast ingredients. Reducing morning friction makes habits automatic.', category: 'productivity', frequency: 'daily', icon: '🌙', color: '#8B5CF6', packName: 'Environmental Design', difficulty: 'beginner', benefits: ['Reduced friction', 'Better mornings', 'Higher follow-through'], sortOrder: 0 },
    { name: 'Phone-Free Morning', description: 'No phone for the first 30 minutes after waking. Protect your morning attention from notifications and social media. Start with intention, not reaction.', category: 'productivity', frequency: 'daily', icon: '📵', color: '#EF4444', packName: 'Environmental Design', difficulty: 'intermediate', benefits: ['Better focus', 'Reduced anxiety', 'Intentional start'], sortOrder: 1 },
    { name: 'Workspace Reset', description: 'Clean and organize your desk at the end of each day. A tidy workspace reduces cognitive load and creates a cue for focused work the next morning.', category: 'productivity', frequency: 'daily', icon: '🧹', color: '#10B981', packName: 'Environmental Design', difficulty: 'beginner', benefits: ['Reduced clutter', 'Better focus', 'Fresh start daily'], sortOrder: 2 },
  ]
